defmodule Mix.Tasks.Gen.Model do
  ...
  """
  def run(args) do
    switches = [connect: :keep, connect_from: :keep, migration: :boolean, binary_id: :boolean, instructions: :string]
    ...
    connect_froms = Keyword.get_values(opts, :connect_from)
    ...
    many_to_many_froms = for connect <- connect_froms do
      [from, to] = String.split(connect, ":")
      field = Macro.underscore(to) <> "s"
      to_module = "#{binding[:base]}.#{to}"
      join =
    ...
    many_to_manys = many_to_manys ++ many_to_many_froms
    ...
    Gen.Phoenix.copy_from paths(), "priv/templates/gen.model", "", binding, files
