defmodule Mix.Tasks.Gen.Json do
  ...
  def run(args) do
    ...
    attrs   = Mix.Phoenix.attrs(attrs) ++ [inserted_at: :naive_datetime, updated_at: :naive_datetime]
    IO.inspect attrs
    ...
    Mix.Gen.Phoenix.copy_from paths(), "priv/templates/gen.json", "", binding, files
